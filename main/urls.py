...
urlpatterns = [
    ...
    path('staff/craftsman/completed_custom_orders/',
         views.craftsman_completedCustomOrders, name='craftsman_completedCustomOrders'),
    path('staff/craftsman/completed_custom_orders/<int:pk>/costom_order_details/',
         views.craftsman_completedCustomOrderDetails, name='craftsman_completedCustomOrderDetails'),
]
