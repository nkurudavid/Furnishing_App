...
class ClientProfile(models.Model):
    client = models.OneToOneField(
        settings.AUTH_USER_MODEL, related_name="client_profile", verbose_name="Client", on_delete=models.CASCADE)
    phone_number = PhoneNumberField(
        verbose_name="Phone Number", blank=True, unique=True)
    location = models.CharField(
        verbose_name="Location", max_length=100, blank=True, null=True)
    shipping_location = models.CharField(
        verbose_name="Shipping Location", max_length=100, blank=True, null=True)
    shipping_street = models.CharField(
        verbose_name="Shipping Street", max_length=50, blank=True, null=True)
